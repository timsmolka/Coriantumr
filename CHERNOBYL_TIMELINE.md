# Chernobyl, 26 April 1986 — A Definitive Factual Chronology

**Reactor No. 4, V. I. Lenin Chernobyl Nuclear Power Plant, near Pripyat, Ukrainian SSR**

This document reconstructs, as precisely as the historical record allows, the order of
events of the Chernobyl disaster: from the start of the turbine-rundown safety test late on
**25 April 1986**, through the explosion at **01:23 on 26 April**, the firefight, the
denial-bound response of plant management, the arrival of the new shift and the Government
Commission, and onward to roughly the **same time the next night (early hours of 27 April)** —
the point at which the minute-by-minute record thins into an overview. After that, it becomes
a summary of the evacuation and the aerial dumping campaign, deliberately less granular, as
the source material itself becomes less exact.

All clock times are **Moscow Summer Time (UTC+4)**, which in 1986 was also Pripyat local time.

---

## A note on sources, method, and honesty

This is built only from **widely acknowledged, factual sources**: the IAEA's INSAG‑1 (1986)
and its correction **INSAG‑7 (1992)**; **UNSCEAR**, **WHO** and **IAEA** casualty data; the
**World Nuclear Association** and **OECD‑NEA** technical sequences; and the standard documentary
histories — **Grigori Medvedev**, *The Truth About Chernobyl*; **Anatoly Dyatlov's** own memoir
*Chernobyl: How It Was*; **Serhii Plokhy**, *Chernobyl: A History*; **Adam Higginbotham**,
*Midnight in Chernobyl* (built on direct interviews); and **Svetlana Alexievich's** oral history
*Voices from Chernobyl / Chernobyl Prayer*.

**Three rules were applied to keep this factual:**

1. **Every error-prone fact was independently cross-checked** — exact timestamps, name spellings,
   roles, and death dates. Where authoritative sources genuinely disagree, the disagreement is
   stated rather than papered over with false precision.
2. **Documented testimony is separated from dramatization.** Many "famous Chernobyl quotes" come
   from the 2019 HBO miniseries, not the historical record. Those are **excluded from the
   narrative** and listed, clearly labelled, in *Appendix C*. The line *"3.6 roentgen — not great,
   not terrible"* and the *"Bridge of Death"* mass-death story are the two most common; **neither is
   historical.**
3. **The most severe genuine uncertainties are flagged inline** — the exact second of the
   explosion, why AZ‑5 was pressed, the cause of the power drop, and a handful of death dates.

> **Sourcing caveat.** This reconstruction was assembled largely from cross-checked search
> summaries of the sources above; direct full-text access to some primary hosts (the INSAG‑7 PDF,
> IAEA, WNA) was not available during compilation. The well-established facts are corroborated
> across multiple independent sources; points resting on a single source or in genuine dispute are
> marked as such.
...
> start/oscillograph commands — but had **no authority over the plant crew**; his instructions passed
...
The reactor was to be shut down for routine maintenance. Engineers planned to use the shutdown to
run a long-delayed **safety test**: could a coasting-down turbogenerator, spinning on its own
inertia after a power cut, generate enough electricity to keep the cooling pumps running for the
...
> **Correction to the popular story:** the dispatcher postponed the *power reduction*, not the
...
| **00:05** | Power reaches **~720 MWt**, heading for the planned 700–1000 MWt test band. | |
| **00:28** | During the transfer of control from local automatic regulation (LAR) to the main-range automatic regulators (AR), **power falls sharply to ~30 MWt** — near shutdown. **Toptunov** is the senior reactor control engineer at the console. | Toptunov, Akimov |
| **00:28–01:00** | Operators **withdraw control rods** to pull power back up; recovery is fought by the deep xenon poisoning, and the operating reactivity margin is eroded. | Toptunov, Akimov |
| **00:43** | The **reactor trip on loss of both turbogenerators is disabled** (so the test could be repeated if needed). Trips on low steam-drum water level and low steam pressure are also blocked around this period. | |
| **01:03** | Reactor **stabilised at only ~200 MWt** — far below the target. The test is allowed to proceed at this low, unstable power. The **seventh (standby) main circulation pump** is switched on. | Akimov, Dyatlov |
| **01:07** | The **eighth pump** is switched on; **all 8 main circulation pumps now run**. The extra flow suppresses steam voids, lowering reactivity and prompting still more rod withdrawal; flow nears cavitation limits. | |
| **01:19** | **Feedwater flow is roughly tripled** to restore the falling steam-drum level. The cooler water further reduces voiding and reactivity, driving more rods out and shrinking the margin toward nothing. | |
...
> needed ~10–15 minutes to compute the margin and had not done so from the 01:22:30 data, so the
> operators probably had **no live reading**. The dangerously low margin itself is not in doubt;
> whether anyone saw it in time is.

## 01:23 — the test, the scram, and the explosions
...
> reconstructions**; the instruments were destroyed. The single most-cited value is **01:23:45**
> (World Nuclear Association: *"at 01:23:45 the 1000 t lid was lifted"*; the Pakhomov–Dubasov 2017
> analysis; the iconic "1:23:45"). Other sources give 01:23:44, :47 or :48. Seismic records show
> **two Rayleigh waves ~2.7 seconds apart**, consistent with two explosions. The **nature** of the
...
- **"The mission is senseless — the control rods, and the reactor itself, no longer exist." / "You've only seen it from below — we need to look from above."** — **Yuvchenko** warning **Perevozchenko** and the two trainees before they climbed to the reactor hall; Perevozchenko overruled him, and Yuvchenko went along ("orders were orders," and he had the only flashlight). *[documented — Higginbotham, paraphrase]*
- **"There's nothing to see here."** — **Perevozchenko** → Yuvchenko, shoving him back from the open core at the +35.5 door — after the trainees had looked in and confirmed what Yuvchenko had said. *[documented]* (as rendered by Higginbotham)
...
**documented** words are included; where a quote is only *reported* (second-hand) or *disputed*,
it is labelled. Dramatized lines are excluded (see *Appendix C*).
...
**Igor Kirschenbaum** *(also Kershenbaum)* — *Senior Turbine Control Engineer.* On Akimov's
...
**Valery Ilyich Khodemchuk** — *Senior main circulation pump operator.* At his post beside the
reactor when it exploded; **killed instantly — the first person to die.** His body was never
recovered and lies entombed in the ruins. A memorial plaque marks the spot inside the plant. He is
...
in the **+10 corridor** by **Perevozchenko** and the two trainees (sent to hand-lower the rods).
**Yuvchenko told them the mission was senseless** — the control rods, and the reactor itself, no
longer existed — but **Perevozchenko countered that Yuvchenko had only seen it "from below," and
they needed to assess the damage from above**; orders were orders, and Yuvchenko had the only
flashlight, so he agreed to help find the way. **Tregub went on to the control room**, and Yuvchenko
joined the other three. Together they **climbed the stairs from ~+12 up toward +35** (Yuvchenko last, *"through a labyrinth of
...
the face and body by the radioactive steam that surged through the open doors at the instant of the
blast; he is credited with **closing the heavy pressurised door to protect colleagues** before
collapsing. **Died of ARS/burns, 12 May 1986.**

**Oleg Genrikh** — *Reactor-hall operator, with Kurguz.* Sheltered in a windowless room, he took
far less of the steam. **Shock, then clear-headed** — he showered and changed to reduce
contamination before evacuating. **Survived**, and gave filmed interviews decades later.

**Viktor Degtyarenko** — *Reactor (coolant pump) operator.* Close to the reactor at the moment of
...
report the fire, then fought the burning turbine-oil spill from a fractured line, taking a massive
dose. **Died of ARS, 14 May 1986.**

**Anatoly Ivanovich Baranov** — *Senior electrician / electrical-shop duty engineer.* Switched the
turbogenerators from hydrogen to nitrogen cooling, **preventing a hydrogen explosion in the machine
hall**. **Died of ARS, 20 May 1986.** *(Not to be confused with diver Boris Baranov or hematologist
Dr. Alexander Baranov.)*

**Kostyantyn (Konstantin) Grigoryevich Perchuk** — *Senior turbine mechanic.* Cut pumps off from
fractured pipes to stop radioactive water flooding the hall and fought the oil fire with Brazhnik.
**Died of ARS, 20 May 1986.**

**Yuri Korneyev** — *Turbine operator.* At the turbines at the moment of the accident. **Survived**
— later reported as the **last living member of the Unit 4 turbine night shift**; radiation-induced
cataracts ended his nuclear career.
...
**Aleksandr Grigoryevich Lelechenko** — *Deputy chief of the electrical shop.* To spare his younger
electricians, he **waded three times through radioactive water to disconnect the hydrogen and
electrolysis units by hand**, averting a hydrogen explosion — absorbing a dose said to be enough
to kill several men. **Died of ARS, 7 May 1986** — one of the earliest deaths. Posthumously Hero of
Ukraine.

**Viktor Lopatyuk** and **Oleksandr Novik** — *electricians* who helped shut down equipment and
localise the fire to Unit 4 without protective gear. **Lopatyuk died 17 May 1986; Novik died in
1986** (commonly 26 July).

## Dosimetry and rescue

**Nikolai Gorbachenko** — *Senior control-room dosimetrist.* **Horror then duty.** His instruments
were useless — the high-range meter burned out when switched on, and portable devices maxed at ~4
R/h while the true fields were thousands. *Documented (Bulletin of the Atomic Scientists):* "Just
as in a horror film, the blast blew out the double doors … Black-red dust started coming out of the
ventilation vent." With Palamarchuk he **found and carried out the dying Shashenok** from room 604,
suffering a radiation burn where Shashenok's hand rested on his back. Hospitalised; **survived**,
released later in 1986.

**Pyotr (Piotr) Palamarchuk** — *Head of a commissioning/survey group.* On Akimov's instruction he
...
broken spine, burns, bloody foam at his mouth. Carried out unconscious by Gorbachenko and
Palamarchuk, he **died about 06:00 on 26 April at the Pripyat medical unit (MSCh‑126)** under chief
physician **Vitaly Leonenko**, without regaining consciousness. **The second fatality, and the
first to be buried.**

## The firefighters

The first alarm was raised within minutes of the blast. The men came in ordinary gear, with **no
respirators, no working dosimeters, and no knowledge that the debris was intensely radioactive** —
they treated it as a serious but conventional fire. Some **kicked or picked up chunks of graphite**
lying on the ground, not knowing what it was (documented via fire-engine driver Grigori Khmel's
testimony in Alexievich). At its peak the response reached roughly **37 crews, ~186 firefighters,
and ~81 engines**. The last surface fires were out by **06:35**, about 4.5 hours after the blast —
leaving the graphite fire burning in the crater.
...
ambulance doctor there were no burn casualties but the situation was unclear — then dropped to his
knees vomiting. **Died of ARS, 11 May 1986.** Posthumous Hero of the Soviet Union.

**Sgt. Vasily (Vasyl) Ivanovich Ignatenko** — *Squad leader, SVPCh‑6.* A robust former amateur
athlete; **cheerful, and at first downplaying the danger** to his wife. Fought the fire closest to
the exposed core. **Died of ARS, 13 May 1986.** His body was so radioactive it was buried in a
soldered zinc coffin inside a wooden one, set in concrete, at Mitino. His wife **Lyudmila
Ignatenko's** testimony (below) is the central human record of the disaster.

**Nikolai (Mykola) Vashchuk** (died **14 May 1986**), **Nikolai (Mykola) Titenok/Tytenok** (died
**16 May 1986**), and **Vladimir (Volodymyr) Tishura** (died **10 May 1986** — the first firefighter
to die) — the other three of **Kibenok's SVPCh‑6 squad** who fought the roof fires and died of ARS.

**Major Leonid Petrovich Telyatnikov** — *Chief of VPCh‑2; off-duty, summoned from home; arrived
...
Surviving firefighters of note: the **Shavrey brothers — Leonid** (highest surviving dose, ~200
rem; died 2012), **Ivan** (died 2020 of COVID‑19) and **Petr**; drivers **Grigori Khmel** and Lt.
**Piotr Khmel** (who had swapped shifts with Pravik — the swap that likely cost Pravik his life and
spared Khmel); **Anatoly Zakharov**; **Alexander Petrovsky**; and **Anatoly Ivanchenko** — all
survived.

**Dr. Valentin Belokon** — *Pripyat ambulance physician on duty.* **Professional and alert**; he
quickly recognised he was seeing **radiation sickness, not fire injuries**, and kept treating the
stricken firefighters and operators (sedatives and anti-emetics for headache, nausea and vomiting)
even as he himself was irradiated. Hospitalised for months; **survived**. Ambulance colleague **Dr.
Skachek** and driver Gumarov were among the first medical responders.

## "A solitary human voice" — Lyudmila Ignatenko

**Lyudmila Ignatenko**, Vasily's pregnant wife, gave the account that opens Alexievich's *Voices
from Chernobyl* — the single most-cited primary testimony of the disaster's human cost. **Love
shading into grief and melancholy, and fierce defiance** of the doctors who warned her away. She
concealed her pregnancy to stay at his bedside in Hospital No. 6 through his physical
disintegration. *Documented (Alexievich):* "I don't know what to talk about — about death or about
love? Or is it the same thing?"; "He started to change — every day I met a brand-new person." She
**survived**; her daughter, born after Vasily's death, lived only hours.

> **Two honest caveats about her testimony.** Her *words* are authentically documented oral
> history. But one physical claim within it — that the baby "absorbed" the radiation and shielded
> her — is **medically disputed**: a person given an external dose does not become a radioactive
> source to others. And Alexievich's book is *literary* oral history — shaped and compressed — not
...
The internationally accepted acute toll is **two immediate deaths and 28 deaths from acute
radiation syndrome (ARS)** within the first ~3–4 months, out of **134 confirmed ARS cases** (of
~237 initially hospitalised, ~600 on site). Most died at **Hospital No. 6** and are buried at
...
# APPENDIX B — Known uncertainties and disagreements

Kept explicit so the record is honest rather than falsely precise:
...
# APPENDIX C — Myths and dramatizations deliberately kept out

These are famous but **not historical**, and appear in the popular imagination largely because of
the 2019 HBO miniseries. They are excluded from the factual narrative above:

- **"3.6 roentgen — not great, not terrible."** A **scripted line** (spoken by the Dyatlov
  character). No source records anyone saying it. The *real* kernel: 3.6 R/h was the **ceiling of the
  small dosimeters** on hand; the true field was ~15,000–20,000+ R/h, and management genuinely
  under-read and downplayed it.
- **The "Bridge of Death."** The story that Pripyat residents gathered on a railway bridge to watch
  the fire and *all later died* is **undocumented legend**. Some residents did glimpse the glow
  (mostly from windows); at least one child witness survived. The "none survived" framing is
  dramatization.
- **"The baby absorbed the radiation."** Emotionally faithful to Lyudmila Ignatenko's real
  testimony, but **medically false** — an externally irradiated person is not a radioactive source
  to others.
- **The instant graphite hand-burn** shown for Vasily Ignatenko is dramatized; beta burns develop
  over hours. But the underlying fact — firefighters handling graphite in ignorance — is **documented**.
...
- **IAEA, INSAG‑1 (1986)** and **INSAG‑7 (1992)**, *The Chernobyl Accident: Updating of INSAG‑1* —
  the authoritative technical reconstruction and its correction.
- **UNSCEAR 2008**, **WHO**, and **IAEA** — casualty and ARS figures (134 ARS cases; 28 ARS deaths).
- **World Nuclear Association**, *Chernobyl Accident* and its *Sequence of Events* appendix; **OECD‑NEA**.
- **Grigori Medvedev**, *The Truth About Chernobyl* (1991) — insider investigator's account.
- **Anatoly Dyatlov**, *Chernobyl: How It Was* (1995) — participant memoir (partisan).
- **Serhii Plokhy**, *Chernobyl: A History* (2018).
- **Adam Higginbotham**, *Midnight in Chernobyl* (2019) — based on direct interviews.
- **Svetlana Alexievich**, *Voices from Chernobyl / Chernobyl Prayer* (1997) — oral testimony,
  incl. Lyudmila Ignatenko.
- **Valery Legasov**, dictated memoir tapes (Pravda extracts, 1988).
- Supporting: Wilson Center Digital Archive (Bryukhanov's report); NEJM 1989 (Baranov/Guskova/Gale);
  Bulletin of the Atomic Scientists; New Scientist (Yuvchenko, 2004); Find A Grave and memorial
  records (death dates).

*Compiled as a cross-checked reconstruction; where sources genuinely disagree, the disagreement is
